...
<body>
	...
	<div class="main-content">
      ...
      <section>
        <div class="part1">
        <img id="idimg" src="assets/products/Perrooo.jpg">
        </div>
      
        <div class="part2">
          <h2 id="idtitle">Nombre Principal</h2>
          <h1 id="idprice">Precio<span>Producto</span></h1>
          <h3 id="iddescription">Descripcion producto</h3>
    ...
    <script type="text/javascript">
		$(document).ready(function(){
            ...
            if (data.datos[i].cod==p){
              document.getElementById("idimg").src="assets/products/"+data.datos[i].rutima;
              document.getElementById("idtitle").innerHTML=data.datos[i].nom;
              document.getElementById("idprice").innerHTML=data.datos[i].pre+"€";
              document.getElementById("iddescription").innerHTML=data.datos[i].des;
            }
